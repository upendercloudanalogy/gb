...
export const closing = {
  ...
  heading: "Take care, Karina",
  sub: "अलविदा — go be wonderfully, impossibly happy.",
  button: "release a wish",
  buttonDone: "gone to the sky 🤍",
  note: "If two days could hold this much light, imagine the whole life waiting for you. Jaa — jee le apni zindagi.",
};
